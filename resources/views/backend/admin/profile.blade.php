...
@section('content')
    ...
    <section class="blog-area section">
        <div class="container">
            <form method="POST" enctype="multipart/form-data" action="{{ route('admin.admin.update', $user->id) }}">
                @csrf
                @method('PUT')
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-6">
                        ...
                        <a href="{{ route('admin.dashboard') }}" type="submit" class="btn btn-info" class="btn btn-primary">
                            {{ __('Back') }}
                        </a>
                        <br>
                        <br>
