...
@section('title', ' Favorite Post View')
@push('css')
            ...
            <div class="social-feed-box">
                <div class="social-avatar">
                    <div class="media-body">
                        <p class=" pull-right"><strong>Favorite </strong><span class="btn btn-xs btn-primary"> {{ $postFavoriteCounts }}</span></p>
                        <form id="approve-form{{ $post->id }}" method="GET" action=" " style="display: none" >
                            @csrf()
                        </form>
